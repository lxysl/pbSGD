...
parser.add_argument('--optim', default='SGDM', type=str, choices=['SGDM', 'Adam', 'RMSprop', 'Adagrad', 'pbSGD', 'pbSGDM', 'pbAdam', 'pbAdam2', 'AdamW', 'pbAdamW', 'Lion', 'pbLion'], help='select optimizer')
