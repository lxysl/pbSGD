...
parser.add_argument('--optim', default='SGDM', type=str, choices=['SGDM', 'Adam', 'RMSprop', 'Adagrad', 'AMSGrad', 'pbAMSGrad', 'pbSGD', 'pbSGDM', 'pbAdam', 'pbAdam2', 'pbAdam3', 'AdamW', 'pbAdamW', 'pbAdamW2', 'Lion', 'pbLion', 'pbLion2'], help='select optimizer')
...
def main():
    ...
    if use_gpu:
        ...
        if args.optim == 'SGDM':
            ...
            optimizer = pbAdam2(model.parameters(), lr=args.lr, gamma=args.gamma, weight_decay=args.weight_decay)
        elif args.optim == 'pbAdam3':
            optimizer = pbAdam3(model.parameters(), lr=args.lr, gamma=args.gamma, weight_decay=args.weight_decay)
        elif args.optim == 'AdamW':
            optimizer = optim.AdamW(model.parameters(), lr=args.lr, weight_decay=args.weight_decay)
        elif args.optim == 'pbAdamW':
            optimizer = pbAdamW(model.parameters(), lr=args.lr, gamma=args.gamma, weight_decay=args.weight_decay)
        elif args.optim == 'pbAdamW2':
            optimizer = pbAdamW2(model.parameters(), lr=args.lr, gamma=args.gamma, weight_decay=args.weight_decay)
        elif args.optim == 'Lion':
            optimizer = Lion(model.parameters(), lr=args.lr, weight_decay=args.weight_decay)
        elif args.optim == 'pbLion':
            optimizer = pbLion(model.parameters(), lr=args.lr, gamma=args.gamma, weight_decay=args.weight_decay)
        elif args.optim == 'pbLion2':
            optimizer = pbLion2(model.parameters(), lr=args.lr, gamma=args.gamma, weight_decay=args.weight_decay)
